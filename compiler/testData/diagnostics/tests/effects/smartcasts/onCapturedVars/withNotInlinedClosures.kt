...
fun complex() {
    ...
    unknownClosure { if (x != null) <!DEBUG_INFO_SMARTCAST!>x<!>.inc() }  // still not changing
...
fun differentClosuresInNesting2() {
    ...
    myRun {
        ...
        unknownClosure { if (x != null) myRun { <!DEBUG_INFO_SMARTCAST!>x<!>.inc() } } // not a changing closure
        myRun { if (x != null) <!DEBUG_INFO_SMARTCAST!>x<!>.inc() }
