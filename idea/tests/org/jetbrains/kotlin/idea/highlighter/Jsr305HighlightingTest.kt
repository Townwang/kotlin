...
class Jsr305HighlightingTest : KotlinLightCodeInsightFixtureTestCase() {
    override fun getProjectDescriptor(): LightProjectDescriptor {
        ...
        val libraryJar = MockLibraryUtil.compileJvmLibraryToJar("idea/testData/highlighter/jsr305library", "jsr305-library",
    ...
    override fun getTestDataPath() = "idea/testData/highlighter/jsr305"
}
